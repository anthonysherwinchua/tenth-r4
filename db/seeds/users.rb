[
  ...
  {"created_at"=>'Sun, 28 Jul 2013 11:17:04 UTC +00:00', "email"=>"admin@tvi.com", "first_name"=>"", "id"=>2, "last_name"=>"", "middle_name"=>"", "updated_at"=>'Sat, 02 Apr 2016 02:47:09 UTC +00:00', "username"=>nil}
].each do |user|
